...
\begin{abstract}
In this paper, we will again examine the new NIS2 security standards, review the mappings to the current set of CIS Controls v8.1, and evaluate the use of CSI benchmarks to assess the readiness of Kubernetes clusters for NIS2 and ensure ongoing compliance, thereby mitigating the risks of cyberattacks.
